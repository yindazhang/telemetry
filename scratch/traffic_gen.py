...
if __name__ == "__main__":
	...
	parser.add_option("-b", "--bandwidth", dest = "bandwidth", help = "the bandwidth of host link (G/M/K), by default 100G", default = "25G")
	parser.add_option("-t", "--time", dest = "time", help = "the total run time (s), by default 0.1", default = "0.2")
