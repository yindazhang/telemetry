...
void set_egress_q_prio(int pipeid){
  ...
  for(i = 0; i < port_num; ++i){
    ...
    bf_tm_q_app_pool_usage_set(DEV_ID, 128*pipeid+i, 6, BF_TM_EG_APP_POOL_3, 1024, BF_TM_Q_BAF_DISABLE, hysteresis);
...
int main(int argc, char **argv) {
  ...
  if (ow_config.gen_seed) {
    init_pktgen(1, PKTGEN_APP_1, 0, ow_config.gap_seed, 0);
  }
